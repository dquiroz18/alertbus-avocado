...
<?php $__env->startSection('script'); ?>
	...
	<script>
		...
		var centerColumns = [0, 1, 2, 3, 4, 5, 7, 9, 10, 12, 13, 14, 15, 16, 17];
		$(document).ready(function () {
			...
			if (localStorage.getItem("data") !== null) {
				...
				var idTransportista = localStorage.getItem('idTransportista');
				var realizados = localStorage.getItem('realizados');
				$('#desde').val(desde);
				$('#hasta').val(hasta);
				$('#empresa').val(idEmpresa);
				$('#transportista').val(idTransportista);
