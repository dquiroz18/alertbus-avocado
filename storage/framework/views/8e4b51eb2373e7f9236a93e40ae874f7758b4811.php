...
<div class="container">
	<table>
		...
		<tr>
			<td colspan="8" style="border-color: white;"><?php echo e($data[0]->nombreEmpresa); ?></td>
		</tr>
		<tr>
			<td colspan="8" height="10px" style="border-color: white;"></td>
		</tr>
		<tr>
			<td colspan="8" align="center" style="border-color: white; text-align: center;"><h3>Manifiesto de Viaje</h3></td>
		</tr>
		<tr>
			<td colspan="8" style="border-color: white; text-align: center;"><?php echo e($data[0]->fecha); ?></td>
		</tr>
		...
		<tr>
			...
			<td colspan="5" align="center"><?php echo e($data[0]->nombreProveedor); ?></td>
		</tr>
		<tr><td colspan="8" height="1.5px" style="border-color: white"></td></tr>
		<tr>
			...
			<td align="center"><?php echo e($data[0]->placaVehiculo); ?></td>
			<td style="background-color: #ededed"><b>Capacidad Vehículo</b></td>
			<td align="center"><?php echo e($data[0]->capacidad); ?></td>
		</tr>
		<tr><td colspan="8" height="1.5px" style="border-color: white"></td></tr>
		<tr>
			<td style="background-color: #ededed"><b>Area</b></td>
			<td colspan="2" align="center"><?php echo e($data[0]->nombreArea); ?></td>
		...
		<tr>
			...
			<td style="text-align: center; background: #2A3F54; color: white" colspan="6" align="center" width="550px"><b>Trabajador</b></td>
		</tr>
			<?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				...
				<tr><td colspan="8" height="1px" style="border-color: white"></td></tr>
		...
		<tr>
			...
			<td colspan="1" style="border-color: white;"></td>
			<td colspan="2" style="border-color: white" align="center">EMPRESA</td>
			<td style="border-color: white;"></td>
		</tr>
		<tr>
			<td style="border-color: white;"></td>
			...
			<td colspan="1" style="border-color: white;"></td>
			<td colspan="2" style="border-color: white" align="center"><?php echo e($data[0]->nombreEmpresa); ?></td>
			<td style="border-color: white;"></td>
		</tr>
