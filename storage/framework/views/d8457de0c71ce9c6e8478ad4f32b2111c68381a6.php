...
<?php $__env->startSection('script'); ?>
	...
	<script>
		...
		$('#buscar').click(function() {
	  	...
	  	data = getModelByParams({idProveedor: o_id}, "<?php echo e(url('mantenimiento/vehiculos/listar')); ?>", 'GET');
		...
		$('#new').on('show.bs.modal', function() {
			if (id != 0) {
				var model = getModelByParams({idVehiculo: id}, "<?php echo e(url('mantenimiento/vehiculo')); ?>", 'GET');
		...
		$('#new form').submit(function(e) {
		  	...
		  	//console.log(data);
		  	if(response = saveModel(data, "<?php echo e(url('mantenimiento/vehiculo')); ?>", 'POST')){
		  		var message = response.message;
		  		var success = response.success;
	  ...
	  $('#delete form').submit(function(e) {
	  	...
	  	var data = $(this).serialize();
	  	//console.log(data);
	  	if(response = saveModel(data, "<?php echo e(url('mantenimiento/vehiculo/delete')); ?>", 'POST')){
	  		var message = response.message;
	  		var success = response.success;
	  		showMessage(success, message);
	  		$('#buscar').trigger('click');
