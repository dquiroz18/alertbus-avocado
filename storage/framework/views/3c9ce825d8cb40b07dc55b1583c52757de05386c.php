        	...
        	<div class="x_content">
        		...
        		<div class="row">
        			...
        			<div class="form-group col-sm-1">
        			 ...
        			 <div class="col-sm-2">
			        	<button type="button" data-toggle="modal" id="copyProgramacion" data-target="#modal" class="btn btn-primary" style="position: relative; margin-top: 25px">Copiar Programación</button>
			        </div>
        		</div>
            </div>
        </div>
