	...
	<table>
		...
		<?php $__currentLoopData = $proveedores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $proveedor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
			...
			<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
				...
				<tr>
					<td style="border-color: white;"></td>
					<td colspan="2" style="border-color: white" align="center" valign="center"><?php echo e($proveedor[0]->nombreProveedor); ?></td>
					<td colspan="1" style="border-color: white;"></td>
					<td colspan="3" style="border-color: white" align="center" valign="center"><?php echo e($empresa); ?></td>
					<td style="border-color: white;"></td>
				</tr>
		<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
