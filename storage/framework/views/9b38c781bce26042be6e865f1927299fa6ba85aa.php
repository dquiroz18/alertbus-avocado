	    ...
	    <div class="row">
	       <div class="col-xs-12">
	           <div class="breadcrumbs">
	               <span>Reportes</span>
	               <span> >> </span>
	               <span><a href="<?php echo e(url('reportes/viajes/')); ?>">Viajes Realizados</a></span>
	               <span> >> </span>
		            ...
		            <thead>
		                ...
		                <tbody>
		                	<?php $__currentLoopData = $result; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
		                		<tr>
		                			<td><?php echo e($row->numeroDocumento); ?></td>
		                			<td><?php echo e($row->nombreTrabajador); ?></td>
		                			<td><?php echo e($row->nroAsiento); ?></td>
		                			<td><?php echo e($row->horaIngreso); ?></td>
		                			<td><?php echo e($row->horaSalida); ?></td>
		                			<td><?php echo e($row->tipoSuspension); ?></td>
		                			<?php if(Auth::user()->tipo=="E"): ?>
		                			<td><button class="btn btn-warning edit" data-toggle="modal" data-target="#new" data-id="<?php echo e($row->idViajeDetalle); ?>"><i class="fa fa-edit"></i></button></td>
									<td><button class="btn btn-danger delete" data-toggle="modal" data-target="#delete" data-id="<?php echo e($row->idViajeDetalle); ?>"><i class="fa fa-remove"></i></button></td>
		                			<?php endif; ?>
		                		</tr>
	...
	<div class="modal fade" tabindex="-1" role="dialog" id="delete">
	  <div class="modal-dialog" role="document">
	    <div class="modal-content">
	      ...
	      <form action="<?php echo e(url('viajes/validacion/trabajador/delete')); ?>" method="POST">
	      	<?php echo e(csrf_field()); ?>
	  ...
	  <div class="modal-dialog modal-lg" role="document">
	    <div class="modal-content">
	      ...
	      <div class="modal-body" style="overflow: hidden;">
	      	<form action="<?php echo e(url('viajes/validacion/trabajador/edit')); ?>" method="POST">
	      						...
	      						<tr id="tr<?php echo e($i); ?>">
				    				<td>
				    					<div class="form-group">
				    						<label>Fecha</label>
				    						<div class="input-group" id="fecha_inicio_date<?php echo e($i); ?>">
				    							<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
				    							<input type="date" id="fecha_inicio<?php echo e($i); ?>" class="form-control" />
				    						</div>
				    					</div>
				    					<div class="form-group">
				    						<label>Hora</label>
				    						<div class="input-group" id="hora_inicio_date<?php echo e($i); ?>">
				    							<span class="input-group-addon"><i class="fa fa-clock-o"></i></span>
				    							<input type="time" id="hora_inicio<?php echo e($i); ?>" class="form-control" />
				    						</div>
				    					</div>
				    				</td>
				    				<td>
				    					<div class="form-group">
				    						<label>Fecha</label>
				    						<div class="input-group" id="fecha_fin_date<?php echo e($i); ?>">
				    							<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
				    							<input type="date" id="fecha_fin<?php echo e($i); ?>" class="form-control" />
				    						</div>
				    					</div>
				    					<div class="form-group">
				    						<label>Hora</label>
				    						<div class="input-group" id="hora_inicio_date<?php echo e($i); ?>">
				    							<span class="input-group-addon"><i class="fa fa-clock-o"></i></span>
				    							<input type="time" id="hora_fin<?php echo e($i); ?>" class="form-control" />
				    						</div>
				    					</div>
				    				</td>
				    				<td>
				    					<button type="button" data-viajedetalle_id="" class="btn btn-primary" id="save<?php echo e($i); ?>" ><i class="fa fa-save"></i></button>
				    				</td>
			    			 	</tr>
	      					<?php endfor; ?>
	      				</tbody>
...
<?php $__env->startSection('script'); ?>
	<script>
		...
		var cabecera = <?php echo json_encode($cabecera); ?>;

		<?php for($i = 0; $i < 1; $i++): ?>
		    $('#tr<?php echo e($i); ?>').hide();

		    $('#fecha_inicio<?php echo e($i); ?>').on('change', function() {
		    	$('#save<?php echo e($i); ?>').prop('disabled', false);
		    });
			$('#fecha_fin<?php echo e($i); ?>').on('change', function() {
				$('#save<?php echo e($i); ?>').prop('disabled', false);
			});
			$('#hora_inicio<?php echo e($i); ?>').on('keyup', function() {
		    	$('#save<?php echo e($i); ?>').prop('disabled', false);
		    });
			$('#hora_fin<?php echo e($i); ?>').on('keyup', function() {
				$('#save<?php echo e($i); ?>').prop('disabled', false);
			});

			$('#save<?php echo e($i); ?>').click(function(){
				var inicio = $('#fecha_inicio<?php echo e($i); ?>').val() + ' ' + $('#hora_inicio<?php echo e($i); ?>').val();
				var fin = $('#fecha_fin<?php echo e($i); ?>').val() + ' ' + $('#hora_fin<?php echo e($i); ?>').val();
				...
				if (viajedetalle_id) {
					$.ajax({
						url: "<?php echo e(url('viajes/validacion/trabajador/editHorario')); ?>",
						method: 'post',
						data: {
							idsViajeDetalle: id,
					...
					$.ajax({
						url: "<?php echo e(url('viajes/validacion/trabajador/addHorario')); ?>",
						method: 'post',
						data: {
							idViaje: idViaje,
							numeroDni: ndoc,
	    ...
	    $('#txtName').focus(function() {
			...
			$.ajax({
				url: "<?php echo e(url('mantenimiento/trabajador/')); ?>" + '/' + ndoc,
				method: 'get',
				success: function(response){
	    ...
	    $('#new').on('show.bs.modal', function(){
	    	if (id != 0) {
				...
				$.ajax({
					url: "<?php echo e(url('viajes/validacion/getTrabajador/')); ?>",
					method: 'post',
					data: {
						idsViajeDetalle: id
					},
		...
		$('#changeCabecera').submit(function (e) {
			...
			$.ajax({
				url: "<?php echo e(url('viajes/realizados/editar')); ?>",
				method: 'post',
				data: data,
				success: function(response){
