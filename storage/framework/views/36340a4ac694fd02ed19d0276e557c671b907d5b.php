...
<?php $__env->startSection('script'); ?>
	...
	<script>
		...
		$('#addTipoVehiculo').click(function() {
			...
			if (response = saveModel({idProveedor: 0, tipoVehiculo: tipoVehiculo}, "<?php echo e(url('mantenimiento/vehiculos/tipo-vehiculo')); ?>", 'POST')){
		...
		$('#addTipoTarifa').click(function() {
			...
			if (response = saveModel({idProveedor: 0, tipoTarifa: tipoTarifa}, "<?php echo e(url('mantenimiento/tarifas/tipo-tarifa')); ?>", 'POST')){
				var message = response.message;
				var success = response.success;
				alert(message);
				if (success == '0') {
