	      ...
	      <div class="modal-body" style="overflow: hidden;">
      		...
      		<div class="row">
	      		...
	      		<div class="col-sm-8" id="showCmbEmpresa">
    				<div class="form-group">
    					<label>Empresa</label>
    					<select id="cmbEmpresa" name="empresa" class="form-control">
    						@foreach ($empresas as $empresa)
    							@if (Auth::user()->idEmpresa == $empresa->idEmpresa)
...
@section('script')
    ...
    $('#tbl_data').on('click', '.edit', function(){
    	...
    	$('#cmbEmpresa').val($(this).data('idempresa'));
    	$('#tipo').trigger('change');
    	$('#password').val('');
    	$('#password').removeAttr('required');
    });
