...
@section('script')
	<script src="{{ asset('app/mantenimiento/fundos.js') }}"></script>
	<script>
	    ...
	    $('#frm_save').submit(function(e) {
			...
			$.ajax({
				url: "{{ url('usuarios/movil/guardar') }}",
				method: 'post',
				data: data,
				success: function(response){
	    ...
	    $('#frm_delete').submit(function(e) {
			...
			$.ajax({
				url: "{{ url('usuarios/movil/eliminar') }}",
				method: 'post',
				data: data,
				success: function(response){
					var rpt_message = response.message;
	    ...
	    $('#frm_restaurar').submit(function(e) {
			...
			$.ajax({
				url: "{{ url('usuarios/movil/restaurar') }}",
				method: 'post',
				data: data,
				success: function(response){
					var rpt_message = response.message;
