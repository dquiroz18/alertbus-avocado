...
<div class="container">
	<table>
		<tr>
			...
			<td colspan="8" style="border-color: white; text-align: right;">{{ date('d/m/Y H:i') }}</td>
		</tr>
		<tr>
		...
		<tr>
			<td colspan="10" style="border-color: white; text-align: center;">{{ $data[0]->fecha }}</td>
		</tr>
		...
		<tr>
			...
			<td colspan="7" align="center">{{ $data[0]->nombreProveedor }}</td>
		</tr>
		...
		<tr>
			...
			<td colspan="3" align="center">{{ $data[0]->placaVehiculo }}</td>
		...
		<tr>
			...
			<td colspan="3" align="center">{{ $data[0]->nombreCentroCosto }}</td>
		</tr>
		<tr><td colspan="10" height="1.5px" style="border-color: white"></td></tr>
		<tr>
		...
		<tr>
			...
			@foreach ($data as $item)
				<tr>
					...
					<td align="center">{{ $item->areaTrabajador }}</td>
				</tr>
		...
		<tr>
			<td style="border-color: white;"></td>
			<td colspan="3" style="border-color: white" align="center">{{ $data[0]->nombreProveedor }}</td>
			<td colspan="1" style="border-color: white;"></td>
			<td colspan="4" style="border-color: white" align="center">{{ $data[0]->nombreEmpresa }}</td>
			<td style="border-color: white;"></td>
		</tr>
